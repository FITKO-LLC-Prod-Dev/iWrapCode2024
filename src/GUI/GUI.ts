class GUI {
    ...
    constructor(container: HTMLElement, menuItems: { text: string; id: string; onClick: () => void }[]) {
    ...
    public addMenu(menuItems: { text: string; id: string; onClick: () => void }[]) {
        // Create menu
      ...
      public addMenuItem(menu: HTMLElement, text: string, className: string, onClick: () => void): HTMLButtonElement {
